...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('okved_id', sa.String(20)),
        sa.Column('created_at', sa.TIMESTAMP, nullable=False, server_default=sa.text('CURRENT_TIMESTAMP')),
        sa.Column('updated_at', sa.TIMESTAMP, nullable=False, server_default=sa.text('CURRENT_TIMESTAMP')),
        sa.ForeignKeyConstraint(['okved_id'], ['okved_it_codes.okved_code'], ondelete='SET NULL')
    )
    op.create_table(
        'founder_types',
        sa.Column('id', sa.BigInteger, primary_key=True),
    ...
    op.create_table(
        ...
        sa.Column('legal_entities_count', sa.Integer, nullable=False, default=0),
        sa.Column('addresses_count', sa.Integer, nullable=False, default=0),
        sa.Column('contact_info_count', sa.Integer, nullable=False, default=0),
        sa.Column('finance_count', sa.Integer, nullable=False, default=0),
        sa.Column('management_count', sa.Integer, nullable=False, default=0),
        sa.Column('founders_count', sa.Integer, nullable=False, default=0),
        sa.Column('created_at', sa.TIMESTAMP, nullable=False, server_default=sa.text('CURRENT_TIMESTAMP'))
    )
    ...
    op.create_index('idx_entities_okved_id', 'legal_entities', ['okved_id'])
...
def downgrade() -> None:
    ...
    op.drop_index('idx_entities_okved_id', table_name='legal_entities')
