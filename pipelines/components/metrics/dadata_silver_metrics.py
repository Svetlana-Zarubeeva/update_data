...
class DadataSilverMetrics(Metrics):
    """Сбор и сохранение метрик выполнения пайплайна DaData Silver"""
    ...
    def log_post_run_metrics(self, transformed_data=None):
        ...
        companies_table = f'"{SILVER_SCHEMA}"."{SILVER_DADATA_TABLE}"'
        ...
        logging.info(f"📈 DaData Silver metrics: total={total}, new={created}, updated={updated}")